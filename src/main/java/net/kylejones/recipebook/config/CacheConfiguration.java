...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, net.kylejones.recipebook.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, net.kylejones.recipebook.repository.UserRepository.USERS_BY_EMAIL_CACHE);
