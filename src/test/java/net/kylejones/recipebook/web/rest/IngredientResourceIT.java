...
class IngredientResourceIT {
    ...
    void createIngredient() throws Exception {
        ...
        assertThat(testIngredient.getAmount()).isEqualByComparingTo(DEFAULT_AMOUNT);
        assertThat(testIngredient.getWeight()).isEqualByComparingTo(DEFAULT_WEIGHT);
    }
    ...
    void putExistingIngredient() throws Exception {
        ...
        updatedIngredient.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).amount(UPDATED_AMOUNT).weight(UPDATED_WEIGHT);
        ...
        assertThat(testIngredient.getAmount()).isEqualByComparingTo(UPDATED_AMOUNT);
        assertThat(testIngredient.getWeight()).isEqualByComparingTo(UPDATED_WEIGHT);
    }
    ...
    void partialUpdateIngredientWithPatch() throws Exception {
        ...
        partialUpdatedIngredient.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).amount(UPDATED_AMOUNT);
    ...
    void fullUpdateIngredientWithPatch() throws Exception {
        ...
        partialUpdatedIngredient.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).amount(UPDATED_AMOUNT).weight(UPDATED_WEIGHT);
