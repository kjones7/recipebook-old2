...
describe('Ingredient e2e test', () => {
  ...
  const ingredientSample = { name: 'Israel generating value-added' };
  ...
  describe('new Ingredient page', () => {
    ...
    it('should create an instance of Ingredient', () => {
      ...
      cy.get(`[data-cy="description"]`).type('Accounts').should('have.value', 'Accounts');

      cy.get(`[data-cy="amount"]`).type('12921').should('have.value', '12921');

      cy.get(`[data-cy="weight"]`).type('99229').should('have.value', '99229');
